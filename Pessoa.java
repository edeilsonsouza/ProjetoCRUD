 ...
 * classe Pessoa 
 * 
 *     1) Classe utilizada para criar um objeto Pessoa.
...
{
        /**
         * Classe utilizada para criar objeto Pessoa.
         * Utiliza o conceito de herança.
         * Recebe informações da superclasse Cadastro.
         */
        
        public Pessoa(String nome,String telefone,String dataNasc,String dataCad,String dataUltAlt, String objCriado) {
            super(nome, telefone,dataNasc,dataCad,dataUltAlt,objCriado);
        }
}